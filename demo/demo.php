...
<div class="container">
	...
	<div class="row-fluid">
		<div class="span4">
			...
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "contrast", array( -50 ) ).'"/><br/>
	...
	<div class="row-fluid">
		<div class="span4">
			...
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "brightness", array( 63 ) ).'"/><br/>
	...
	<div class="row-fluid">
		<div class="span4">
			<h5>More <small class="muted">(+50%)</small></h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "gamma", array( 1.5 ) ).'"/><br/>
			<code>gamma( 1.5 )</code>
		</div>
		<div class="span4">
			<h5>Less <small class="muted">(-50%)</small></h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "gamma", array( 0.5 ) ).'"/><br/>
			<code>gamma( 0.5 )</code>
		</div>
	</div>
	<br/>
	...
	<div class="row-fluid">
		<div class="span4">
			<h5>Gaussian blur</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "blurGaussian" ).'"/><br/>
			<code>blurGaussian()</code>
		</div>
		<div class="span4">
			<h5>Selective blur</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "blurSelective" ).'"/><br/>
			<code>blurSelective()</code>
		</div>
		<div class="span4">
			<h5>Smooth</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "smooth", array( 1 ) ).'"/><br/>
			<code>smooth( 1 )</code>
		</div>
	</div>
	<br/>
	...
	<div class="row-fluid">
		<div class="span4">
			<h5>Invert</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "negate" ).'"/><br/>
			<code>negate()</code>
		</div>
		<div class="span4">
			<h5>Remove mean</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "removeMean" ).'"/><br/>
			<code>removeMean()</code>
		</div>
		<div class="span4">
			<h5>Edges</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "detectEdges" ).'"/><br/>
	...
	<div class="row-fluid">
		<div class="span4">
			<h5>Emboss</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "emboss" ).'"/><br/>
			<code>emboss()</code>
		</div>
		<div class="span4">
			<h5>Grayscale</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "grayscale" ).'"/><br/>
			<code>grayscale()</code>
		</div>
	</div>
	<br/>
	...
	<div class="row-fluid">
		<div class="span4">
			<h5>Redish</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "colorize", array( 63, -31, -31 ) ).'"/><br/>
			<code>colorize( -63, 0, 127 )</code>
		</div>
		<div class="span4">
			<h5>Greenish</h5>
			<img class="img-polaroid img-rounded" src="'.(string) applyFilter( $original, "colorize", array( -63, 91, -31 ) ).'"/><br/>
